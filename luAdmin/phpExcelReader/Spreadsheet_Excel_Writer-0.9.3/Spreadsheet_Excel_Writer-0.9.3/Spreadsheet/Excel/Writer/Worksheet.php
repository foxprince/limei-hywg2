...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter {
	 ...
	 * @param integer $index
	 *        	The index of the new worksheet
	 * @param
	 ...
	 *        	The array of sheetnames from the Workbook this
	...
	function setMerge($first_row, $first_col, $last_row, $last_col) {
		...
		$this->_merged_ranges [$this->_merged_cells_record] [] = array (
				$first_row,
				$first_col,
				$last_row,
				$last_col 
	 ...
	 * i.e.
	 * the worksheet that is displayed when the workbook is opened.
	 ...
	 * @param integer $level
	 *        	The optional outline level
	 */
	function setColumn($firstcol, $lastcol, $width, $format = null, $hidden = 0, $level = 0) { // added by Dan Lynn <dan@spiderweblabs.com) on 2006-12-06
...
elseif ($firstcol <= $existing_start && $lastcol >= $existing_end) {
	 ...
	 * @access private
	 * @param string $cell
	 *        	The cell reference. Or range of cells.
	 * @return array
	 */
	 ...
	 *        	The password to be encoded in plaintext.
	 ...
	 *        	The encoding. Ex: 'UTF-16LE', 'utf-8', 'ISO-859-7'
	 */
	 ...
	 * @access private
	 * @param array $array
	 *        	array containing ($rwFirst,$colFirst,$rwLast,$colLast)
	 * @see setSelection()
	 */
	 ...
	 * @param integer $scale_x
	 *        	The horizontal scale
	 * @param integer $scale_y
	 *        	The vertical scale
	 */
