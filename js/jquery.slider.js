    ...
    template: jSliderTmpl(
      '<span class="<%=className%>">' +
        '<table><tr><td>' +
          ...
          '<div class="<%=className%>-label"><span><%=settings.fromtext%></span></div>' +
          '<div class="<%=className%>-label <%=className%>-label-to"><span></span></div>' +

          '<div class="<%=className%>-value"><span></span></div>' +
          '<div class="<%=className%>-value <%=className%>-value-to"><span></span></div>' +
    ...
    create: function(){
      ...
      this.domNode = $( OPTIONS.template({
        ...
        settings: {
          ...
          fromtext: this.settings.fromtext,
          totext: this.settings.totext,
        },
