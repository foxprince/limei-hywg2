...
<!-- 步骤 -->
    <div class="step-box">
      <ul class="step">
        <li class="tc one-box">
          <div><!-- 此处为背景控件active -->
            <div class="one"><a class="link" href="intro.php?c=orderStep"><span>定制首饰步骤简介</span></a></div>
          </div>
        </li>
        <li class="two-box">
          <div id="step1" class = "<?php echo $firstClass;?>"><!-- 此处为背景控件active -->
            ...
            <?php }else{ ?>
            <img src="./images/step-three.png" alt=""><a class="link " href="dia.php"><span>选择裸钻</span></a><?php }?>
            </div>
          </div>
        </li>
        <li class="tc three-box">
          <div id="step2" class="<?php echo $secondClass;?>">
        	...
        	<?php }else{ ?>
            <img src="./images/step-two.png" alt=""><a class="link " href="jewelry.php"><span>选择款式</span></a><div class="icon"></div><?php }?>
            </div>
          </div>
        </li>
        <li class="tc four-box">
          <div id="step3">
            <div class="four"><p id="totalPrice" style="margin-top: -13px;">总计:<?php echo $priceDesc.($jewPrice+$diaPrice) ?></p>
