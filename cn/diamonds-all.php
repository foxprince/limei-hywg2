...
<div id="filter_box_inner">
                    <div class="filter_line">
                        <div class="filter_line_inner" style="border-width: 1px;">
                            <span class="filter_title" id="filter_title_shape">形状<br>
                                shape</span>
                            <ul class="fileber_shape_outer">
                                <li class="filter_shape" id="filter_shapeBR" onclick="filter_shape(&#39;BR&#39;)">
                                    <img src="http://211.90.87.226:7787/images/01.gif"></li>
                                <li class="filter_shape" id="filter_shapePS" onclick="filter_shape(&#39;PS&#39;)">
                                    <img src="http://211.90.87.226:7787/images/02.gif"></li>
                                <li class="filter_shape" id="filter_shapePR" onclick="filter_shape(&#39;PR&#39;)">
                                    <img src="http://211.90.87.226:7787/images/03.gif"></li>
                                <li class="filter_shape" id="filter_shapeHS" onclick="filter_shape(&#39;HS&#39;)">
                                    <img src="http://211.90.87.226:7787/images/08.gif"></li>
                                <li class="filter_shape" id="filter_shapeMQ" onclick="filter_shape(&#39;MQ&#39;)">
                                    <img src="http://211.90.87.226:7787/images/05.gif"></li>
                                <li class="filter_shape" id="filter_shapeOV" onclick="filter_shape(&#39;OV&#39;)">
                                    <img src="http://211.90.87.226:7787/images/11.gif"></li>
                                <li class="filter_shape" id="filter_shapeEM" onclick="filter_shape(&#39;EM&#39;)">
                                    <img src="http://211.90.87.226:7787/images/10.gif"></li>
                                <li class="filter_shape" id="filter_shapeRAD" onclick="filter_shape(&#39;RAD&#39;)">
                                    <img src="http://211.90.87.226:7787/images/06.gif"></li>
                                <li class="filter_shape" id="filter_shapeCU" onclick="filter_shape(&#39;CU&#39;)">
                                    <img src="http://211.90.87.226:7787/images/12.gif"></li>
                            </ul>
                        </div>
                        <div class="filter_line_inner" id="filter_line_color" style="border-width: 1px;">
                            <span class="filter_title">颜色<br>
                                color</span>
                            <ul>
                    ...
                    <div class="filter_line">
                        <div class="filter_line_inner" id="filter_line_symm" style="border-width: 1px;">
                            <span class="filter_title">对称性<br>
                                sym</span>
                            <ul>
                    ...
                    <div class="filter_line">
                        ...
                        <div class="filter_line_inner" style="padding:20px 0px;width:900px;">
                            <span class="filter_title" style="top: 20px;">重量<br>
                                carat</span>
                    ...
                    <div class="filter_line">
                        ...
                        <div class="filter_line_inner" style="width:900px;">
                            <span class="filter_title" style="top: -5px;">价格(美元)<br>
                                price($)</span>
                    ...
                    <div class="filter_line">
                        ...
                        <div class="filter_line_inner" id="filter_line_stockref" style="left: 0; width: 600px; line-height: 45px;">
                            <span class="filter_title" style="display: inline-block; position: relative; top: 0px;">按库存编号/证书编号查询</span>
