		...
		<div class="side-bar fl">
			<ul>
					...
					<div class="div1" <?php if(strstr($_SERVER['REQUEST_URI'],'about.php?p=brandstory#antwerp')||strstr($_SERVER['REQUEST_URI'],'about.php?p=brandstory#chineseantwerp')||strstr($_SERVER['REQUEST_URI'],'about.php?p=brandstory#chaunsstory')){ echo 'style="display:block;"';} ?> >
						<ul class="ul_2">
							<li class="li_2" style="position: relative;">
								<a href="about.php?p=brandstory#antwerp" onclick="document.getElementById('antwerp').scrollIntoView(true);return false;" class="a_menu2">世界钻石之都</a>
							</li>
							<li class="li_2" style="position: relative;">
								<a href="about.php?p=brandstory#chineseantwerp" onclick="document.getElementById('chineseantwerp').scrollIntoView(true);return false;"class="a_menu2">中国人在安特</a>
							</li>
							<li class="li_2" style="position: relative;">
				...
				<li class="li_1">
					<a href="about.php?p=publicmedia" class="a_menu1" <?php if(strstr($_SERVER['REQUEST_URI'],'about.php?p=publicmedia')){ echo 'style="color:#b68168;"';} ?>>媒体报道</a>
				</li>
				<li class="li_1">
