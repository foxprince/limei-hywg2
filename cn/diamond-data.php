				...
				<div class="dia-piece-box" onclick="showDetail('<?php echo $row['id']; ?>')">
                    ...
                    <div id="detail-<?php echo $row['id']; ?>" class="details">
                        <p class="details_txt">
                            ...
                            <span>证书编号: <a class="certi_linker" target="_blank" href="<?php echo $certi_linker; ?>"><?php echo $row['certificate_number']; ?> &nbsp; &nbsp;<a class="certi_linker" target="_blank" href="aboutus.php">咨询客服</a></span>
